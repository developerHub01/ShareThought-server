...
const NOTIFICATION_TYPES = {
  ...
  ...NotificationUtils.generateReactionNotificationType({
    prefix: POST_REACTION,
    reactionList: PostReactionConstant.POST_REACTION_TYPES,
  }),
  ...NotificationUtils.generateReactionNotificationType({
    prefix: COMMENT_REACTION,
    reactionList: CommentReactionConstant.COMMENT_REACTION_TYPES,
  }),
};
