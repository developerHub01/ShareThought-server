...
export default {
  ...
  JWT_CHANNEL_ACCESS_SECRET: process.env.JWT_CHANNEL_ACCESS_SECRET as string,
  JWT_GUEST_SECRET: process.env.JWT_GUEST_SECRET as string,
  JWT_MODERATOR_SECRET: process.env.JWT_MODERATOR_SECRET as string,
  ...
  JWT_MODERATOR_REQUEST_SECRET: process.env
    .JWT_MODERATOR_REQUEST_SECRET as string,

  JWT_ACCESS_EXPIRES_IN: process.env.JWT_ACCESS_EXPIRES_IN as string,
  JWT_REFRESH_EXPIRES_IN: process.env.JWT_REFRESH_EXPIRES_IN as string,
  JWT_EMAIL_VERIFICATION_EXPIRES_IN: process.env
    .JWT_EMAIL_VERIFICATION_EXPIRES_IN as string,
  JWT_FORGET_PASSWORD_EXPIRES_IN: process.env
    .JWT_FORGET_PASSWORD_EXPIRES_IN as string,
  JWT_MODERATOR_REQUEST_EXPIRES_IN: process.env
    .JWT_MODERATOR_REQUEST_EXPIRES_IN as string,
